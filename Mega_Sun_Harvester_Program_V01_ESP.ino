...
//**************************************************************
//  Name    : ESP8266 Sun Harvester Program V01
//  Author  : Gabriel Miller      
//  Forked by: Moritz Metz and friends
//  Website : http://www.cerebralmeltdown.com  && http://netzbasteln.de                             
//  Notes   : Code for controlling various types of solar       
//          : machines using an ESP8266 Microcontroller.                   
// Licence: Creative Commons Attribution-Noncommercial-Share Alike 3.0 United States License.        
// Licence-URL: https://creativecommons.org/licenses/by-nc-sa/3.0/us/
...
//PUT YOUR LATITUDE, LONGITUDE, AND TIME ZONE HERE
  float latitude = 52.49;
  float longitude = 13.43;
  float timezone = +2;
...
//Machine Wind Protection Park Angle
 ...
 float machineAzParkAngle=0;
  ...
  ///////////////////////////////////////////////////////////
    ...
    int joystickUDAnalogPin = 0;
    int joystickLRAnalogPin = 1;
